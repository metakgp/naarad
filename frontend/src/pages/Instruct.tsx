            ...
            <div class="ins-main">
                ...
                <div class="ins-info">
                    ...
                    <ol class="ins-info-dsktp">
                        <li>Visit <a href="https://naarad.metakgp.org/web" target="_blank">Naarad Portal</a> and click on signin, enter your confidentials used during registration and click on Sign In.</li>
                    ...
                    <ol class="ins-info-mobile">
                        <li>Download <a href="https://play.google.com/store/apps/details?id=io.heckel.ntfy&hl=en_IN&pli=1" target="_blank">NTFY app</a> from play store.</li>
